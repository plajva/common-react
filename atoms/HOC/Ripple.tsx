 ...
 * @param props 
 */
const Ripple = <T extends React.HTMLAttributes<HTMLElement>>(Comp: ComponentType<T>, props?: RippleProps): FunctionComponent<T & RippleProps> => {
	// Sets defaults
	...
	const ripple = ({ onClick, ...props }:T) => <Comp {...props as T} onClick={combineEvent((e) => createRipple(e, { ...rprops_d, ...props }), onClick)} />;
	return ripple;
}
